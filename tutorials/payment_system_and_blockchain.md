...
UTXO-based sistemler, BTC ve bazı forkları tarafından kullanılan modeldir. Account-based ise Ethereum ve bazı forkları tarafından kullanılan modeldir.
...
contract ExampleDapp {
    ...
    function method99() public {
        ...
        // require is a function which throws exception 
...
Ethereum blockchain'ine contact'ların kendileri de store edilmektedir.
...
// when we call "request" function from JS, the MetaMask extension will show a popup to end-user and it will ask for permisson to show the accunt to the current web page. 
